...
bins = 10
range = (3.5, 8.5)
template = Template1d("Iris", bins, range, data=x, color="skyblue")
...
bins = (10, 10)
range = ((2, 9), (1, 5))
template = Template2d("2dIris", ("length", "width"), bins, range, data=(x, y), color="gold")
...
fig, ax = plt.subplots(1, 1, dpi=200, figsize=(4, 4))
template.plot_x_projection_on(ax)
ax.legend()
plt.show()
plt.close(fig)
