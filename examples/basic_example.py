...
def run_basic_example():
    ...
    fit_result = fitter.do_fit(update_templates=True, get_hesse=True, verbose=False, fix_nui_params=False)
    ...
    for yield_parameter in param_handler.get_parameter_names_for_type(ParameterHandler.yield_parameter_type):
        significance_dict[yield_parameter] = fitter.get_significance(
            yield_parameter=yield_parameter, fix_nui_params=False, verbose=False, catch_exception=True
        )
